...
import { RightTransition } from "../../components/ui/transitions"
			...
			<section className='pt-[200px] pb-32 min-h-screen bg-slate-900/30'>
				<div className='mx-auto max-w-7xl'>
					<div className='xl:grid xl:grid-cols-2 items-center xl:h-[70vh] gap-12 justify-between'>
						<RightTransition>
							<article className='text-slate-50 flex flex-col gap-6 justify-center px-6'>
								...
								<p className='text-center xl:text-left xl:text-lg text-slate-200'>
									MedExcel is a great revision resource for Medical Students supplying questions from
								...
								{!auth.user ? (
									<>
										...
										<div className='max-xl:mx-auto flex items-center gap-4 sm:gap-6 group max-w-fit'>
											<Link
												...
												to='/subscription'
											>
												<p className='hidden sm:block'>See pricing</p>
												<p className='block sm:hidden'>Pricing</p>
												<svg
													className='w-5'
													fill='none'
													stroke='currentColor'
											...
											<Link
												...
												to='/signin'
											>
												<p className='hidden sm:block'>Have an account?</p>
												<p className='block sm:hidden'>Sign up</p>
												<svg
													className='w-5'
													fill='none'
													stroke='currentColor'
									...
									<div className='flex gap-6 group max-w-fit max-xl:mx-auto'>
										<Link
											...
											to='/account'
										>
											<p className='hidden sm:block'>See account</p>
											<p className='block sm:hidden'>Profile</p>
										...
										<Link
											...
											to='/exam'
										>
											<p className='hidden sm:block'>Start exam</p>
