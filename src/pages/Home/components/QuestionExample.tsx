...
Physical examination reveals subcostal recessions, nasal flaring and wheezing. The patient has no other significant medical history. He has been achieving his development goals and has been fully vaccinated.
	...
	return (
		<div
			className={`relative bg-slate-800 max-h-[600px] p-8 rounded-md shadow-md border border-gray-100/10 text-white ${
				showModal ? "overflow-y-" : "overflow-y-auto"
			}`}>
			<div
				className={`absolute inset-x-0 duration-700 transition-all bg-opacity-100 bg-gradient-to-b from-slate-900/50 to-black/70 flex items-center justify-center bottom-0 ${
					showModal
