...
const Footer = ({ cols }: IProps) => {
	...
	return (
		<footer className='text-slate-50 font-medium tracking-wide bg-slate-900/80 border-t border-t-slate-50/30'>
			<div className='max-w-2xl mx-auto py-20'>
				...
				<p className='text-lg text-center block font-semibold mt-14'>
